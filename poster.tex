...
{ \textsc\small{ Bedrij Walter, Benitez Federico, Benitez Fernado \\ \footnotesize {wbedrij@gmail.com, federicobenitez2@gmail.com, fernandobenitezfich@gmail.com} } }  { \includegraphics[height=7.0em]{fich2} }
...
\headerbox{Resultados}{name=resultados,column=1,span=2,below=nn}{
		\begin{itemize}\compresslist
  ...
  \headerbox{Conclusión y Futuro Trabajo}{name=questions,below=metodos}{
		\begin{itemize}\compresslist
		...
		\item Para intentar solventar esos problemas se propone:
			\begin{itemize}\compresslist	
				 ...
				 \item Realizar un refinamiento en la selección del punto característico,por ejemplo, discriminar los dedos
	  		\end{itemize}
		\end{itemize}
  }
