...
\usepackage{polyglossia} %reemplaza a babel
...
{ \Large\bf\textsc{Justificación, Redacción de Objetivos y Definición de Alcances de un Proyecto} }
{ \textsc\small{ \large{Bedrij Walter, Benitez Federico} \\ \footnotesize {wbedrij@gmail.com, federicobenitez2@gmail.com} } }  { }%\includegraphics[height=5.0em]{fich2} }
	...
	La justificación presenta los principales argumentos que permite convencer el por qué  es necesario llevarlo a cabo el proyecto como también verificar su viabilidad. \\
La elaboración de objetivos nos permite la planificación y seguimiento del proyecto.\\
Un proyecto necesita cumplir determinados requisitos y se encuentra limitado por ciertas restricciones, estas consideraciones quedan definidos en su alcance. 
	}
...
\begin{tabular}
	{ >{\Huge\centering\arraybackslash}m{.1\linewidth} | >{\arraybackslash}m{.8\linewidth} }
	S &
	\Nombre{Specific (Específico):}
		Dejar explícito, para que no haya ambigüedad.
	...
	\\
	M &
	\Nombre{Measurable (Medible):}
		Definir criterios que indiquen que se logró el resultado esperado (o qué tan lejos estamos)
	\\
	A &
	\Nombre{Achievable (Alcanzable):}
		¿Se puede lograr con los recursos que disponemos?
		¿Entendemos las restricciones?
		¿Es posible y práctico?
	\\
	R &
	\Nombre{Relevant (Relevante):}
		Cómo el objetivo se relaciona con el rol de cada miembro del equipo, y los objetivos de la organización.
	\\
	T &
	\Nombre{Time-bound (Limitado en el tiempo):}
		Definir fechas límite.
	\\
\end{tabular}
\egroup
...
El objetivo general debe describir la finalidad principal que persigue
el proyecto.\\
Los objetivos específicos deben representar lo que se pretende alcanzar de forma concreta
y que contribuyen a obtener el resultado del objetivo general.

\begin{center}	
		\includegraphics[width=1\linewidth]{obgye}
\end{center} 

}


\headerbox{Desarrollo}{name=alca,column=1,span=1}{
		
\section*{Definir el Alcance} 
...
se irán agregando nuevos riesgos, supuestos y restricciones. 
	...
	\begin{center}	
		\includegraphics[width=.55\linewidth]{alcance}
	\end{center}
}

\headerbox{Ejemplos}{name=ejemplo,column=1,span=1,below=alca}{
...
Planning.
		...
		\bibitem{01:PFG}
		\newblock{Estructura básica para elaborar un Proyecto Final de Graduación.}
