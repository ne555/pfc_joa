...
Se realiza la diferencia entre los canales RGB del frame actual contra la imagen de referencia del fondo. Esto permite discriminar al objeto.
...
%
  ...
  \headerbox{Trabajo Futuro}{name=questions,below=metodos,above=referencias}{
