...
En este trabajo se presenta el diseño e implementación de un sistema para
el reconocimiento de signos manuales en tiempo real, mediante el procesamiento del flujo de video de una cámara web estándar en un ambiente de
trabajo controlado.
Todos los algoritmos descriptos son de implementación propia. Recursos
similares de una biblioteca específica para el procesamiento de imágenes sólo
se utilizaron al momento de obtener una medida objetiva del desempeño
de aquellos procedimientos que más tiempo consumen dentro del esquema
general.
